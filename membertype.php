...
<html lang="en" dir="ltr">
  ...
  <div id="main">
		<div class="limiter">
		 <div class="container-memty">
			 <div class="wrap-memty">
				 <form action="membertype.php" class='needs-validation form-horizontal  table-striped' id="formsq" role='form' method="post" novalidate>
			 	...
			 	<label class='col-form-label label_form_font'  style="text-align: right">สืบค้นโดย</label>
			 			...
			 			<option value="mid">รหัสประเภทสมาชิก</option>
			 				<option value="mname">ชื่อประเภทสมาชิก</option>
			 	...
			 	if(isset($_POST['submit_q']))
			 	{
			 		switch($sq)
			 		{
			 			...
			 			$sql = "SELECT membertype.MemberTypeID AS mid,membertype.MemberType AS mname
			 					FROM membertype WHERE MemberTypeID = $keyword
			 					ORDER BY MemberTypeID ASC limit {$start} , {$perpage};";

			 			$sql2 = "SELECT membertype.MemberTypeID AS mid,membertype.MemberType AS mname
			 					FROM membertype WHERE MemberTypeID = $keyword
			 					ORDER BY MemberTypeID ASC;";
			 			break;
			 			case 'mname':
			 			$sql = "SELECT membertype.MemberTypeID AS mid,membertype.MemberType AS mname
			 					FROM membertype WHERE membertype LIKE '%$keyword%'
			 					ORDER BY MemberTypeID ASC limit {$start} , {$perpage};";
			 					...
			 					<tr style="text-align: center">
			 						 ...
			 						 ?>
			 									...
			 									<img src="public/images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"  name="edit" value="edit" id="<?php echo $row->mid; ?>" class="edit"/>
			 									 &ensp;
			 										<a  href="del_memtype.php?mid=<?=$row->mid;?>" onClick="ts();">
			 										<img src="public/images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบข้อมูลประเภทสมาชิก รหัส <?php echo $row->mid;?> ใช่หรือไม่')"/></a>
			 									</td>
			 									</tr>
			 						<?php
			 									 $ct++;
			 ...
			 ?>
			 	 <nav class="Page navigation example">
			 		<ul class="pagination justify-content-center">
			 			<li class="page-item">
			 				<a class="page-link" href="membertype.php" aria-label="Previous">
			 					...
			 					{
			 					?>
			 						<li class="page-item"><a class="page-link" href="membertype.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
			 					<?php
			 					}
			 					?>
			 					 <li class="page-item">
			 						<a class="page-link" href="membertype.php?page=<?php echo $total_page;?>" aria-label="Next">
			 ...
			 <form class="needs-validation" method="post" action="edit_memtype.php" novalidate>
			 ...
			 <div class="modal-dialog modal-dialog-centered" role="document">
			 <div class="modal-content">
			 <form class="needs-validation" method="post" action="add_memtype.php" novalidate>
			 	<div class="modal-header">
			 		<h5 class="modal-title labelH_form_font" id="add_label">เพิ่มข้อมูลประเภทสมาชิก</h5>
			 	</div>
			 	<div class="modal-body">

			 		<div class="form-group">
			 				<label for="mid" class="col-form-label label_form_font">รหัสประเภทสมาชิก</label>
			 				<input type="text" class="form-control" id="mid" name="mid" pattern="([0-9]{1,2}$)"  required>
