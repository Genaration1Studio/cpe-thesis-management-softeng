...
<html lang="en" dir="ltr">
  ...
  <div id="main">
		<div class="limiter">
		 <div class="container-tiname">
			 <div class="wrap-tiname">
			 					...
			 					<tr style="text-align: center">
			 						...
			 						<th>การจัดการ</th>
			 						 ...
			 						 ?>
			 									...
			 									<img src="public/images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"  name="edit" value="edit" id="<?php echo $row->ttid; ?>" class="edit"/>
			 									 &ensp;
			 										<a  href="del_title.php?ttid=<?=$row->ttid;?>" onClick="ts();">
			 										<img src="public/images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบคำหน้าชื่อ รหัส <?php echo $row->ttid;?> ใช่หรือไม่')"/></a>
			 									</td>
			 									</tr>
			 						<?php
			 									 $ct++;
