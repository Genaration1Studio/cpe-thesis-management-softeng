				 			 ...
				 			 <thead>
				 				<tr style="text-align: center">
				 					 ...
				 					 ?>
				 								...
				 								<img src="public/images/baseline_border_color_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="แก้ไข"  name="edit" value="edit" id="<?php echo $row->did; ?>" class="edit"/>
				 								 &ensp;
				 									<a  href="del_dept.php?did=<?=$row->did;?>" onClick="ts();">
				 									<img src="public/images/baseline_delete_forever_black_36dp.png" width="20px" data-toggle="tooltip" data-placement="bottom" title="ลบ" onClick="return confirm('ต้องการลบข้อมูลสาขาวิชา รหัส <?php echo $row->did;?> ใช่หรือไม่')"/></a>
				 								</td>
				 								</tr>
				 					<?php
				 								 $ct++;
